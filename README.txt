...
a persistence unit "erPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "er/pom.xml":
...
artifact ("er.war") is already built. You can build
